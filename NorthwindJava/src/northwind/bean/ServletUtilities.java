...
public class ServletUtilities {
	 ...
	 * 
	 * Specifically, given a string, this method replaces all occurrences of:
	 * '<' with '&lt;', all occurrences of '>' with '&gt'
	 * and (to handle cases that occur inside attribute values), 
	 * all occurrences of double quotes with '&quot;' 
	...
	/**
	 * Chceck for special characters in input: < > " &
	 * @param input
	 * @return boolean
	 */
